...
class SortingDisplay extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        floorHeight = getHeight() / 20;
        heightMargin = (getHeight() - (getHeight() / (double)sortingDisplayInformation.list.size())) / (double)sortingDisplayInformation.list.size();
        // draw sort name
        g.setColor(blue);
    ...
    private void drawFloor(Graphics g) {
        // will draw a black rectangle the length of the panel and the height 20% of the panel height
    ...
    private void drawElements(Graphics g) {
        ...
        for (int i = 0; i < listSize; i++) {
            ...
            if(yResize != 1) {
                y += (element * heightMargin + MINIMUM_HEIGHT) / yResize;
            }
            ...
            g.fillRect(x, y, (int) WIDTH_MARGIN, (int) ((element * heightMargin + MINIMUM_HEIGHT) / yResize));
            g.setColor(blue);
    ...
    private int getY(int elementValue) {
        ...
        return (int) ((getHeight() - floorHeight) - (elementValue * heightMargin) - MINIMUM_HEIGHT);
    }
